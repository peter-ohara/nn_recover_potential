...
% Last Modified by GUIDE v2.5 14-Apr-2014 13:06:36
...
elseif isnan(compartmentalisation) || ~isreal(compartmentalisation) || compartmentalisation < 1 || compartmentalisation > 5
    ...
    plot(handles.regression_axes, handles.targets, handles.outputs, 'r+', 'MarkerSize', 10);
    grid on;
...
set(handles.viscosity_input,'String','');
set(handles.arealDensity_input,'String','');
set(handles.heterogeneity_input,'String','');
...
set(handles.compartmentalisationScored_input,'String','1');
